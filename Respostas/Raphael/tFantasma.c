 ...
 * \param fantasmas Vetor de ponteiros para fantasmas
 */
void MoveFantasmas(tFantasma** fantasmas, tMapa* mapa, tPacman* pacman) {
    // FANTASMA B EXISTE
    if (fantasmas[0] != NULL) {
        if (FantasmaBateuParede(fantasmas[0], mapa)){
            MudaDirecaoFantasma(fantasmas[0]);
            MoveFantasma(fantasmas[0], mapa, pacman);
        }
        else {
            MoveFantasma(fantasmas[0], mapa, pacman);
        }
    ...
    if (fantasmas[1] != NULL) {
        if (FantasmaBateuParede(fantasmas[1], mapa)){
            ...
            MoveFantasma(fantasmas[1], mapa, pacman);
        }
        else {
            MoveFantasma(fantasmas[1], mapa, pacman);
        }
    ...
    if (fantasmas[2] != NULL) {
        if (FantasmaBateuParede(fantasmas[2], mapa)){
            ...
            MoveFantasma(fantasmas[2], mapa, pacman);
        }
        else {
            MoveFantasma(fantasmas[2], mapa, pacman);
        }
    ...
    if (fantasmas[3] != NULL) {
        if (FantasmaBateuParede(fantasmas[3], mapa)){
            ...
            MoveFantasma(fantasmas[3], mapa, pacman);
        }
        else {
            MoveFantasma(fantasmas[3], mapa, pacman);
        }
